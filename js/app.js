(() => {
    ...
    function initSliders() {
        if (document.querySelector(".carousel__slider")) new core(".carousel__slider", {
    ...
    let glowInTexts = document.querySelectorAll(".slide-content__title");
    glowInTexts.forEach((glowInText => {
        ...
        letters.forEach(((letter, i) => {
            ...
            span.style.animationDelay = `${.05 * i}s`;
